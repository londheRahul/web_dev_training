...
useGSAP(()=>{
  ...
  useGSAP(() => {
    gsap.fromTo(paragraph.current, { y: 100, opacity: 0 }, { y: 0, opacity: 1, duration: 3, ease: "bounce.out" })
  });
  return (
    <div className='flex flex-col items-center h-fit text-center px-20 pt-30 bg-gray-200'>
  ...
  {info.map((item) => (
    <InfoCard key={item.id} info={item} />
      ...
      <div className='bg-gradient-to-br from-black via-blue-950 to-black h-fit pb-10 w-screen pt-25' >
